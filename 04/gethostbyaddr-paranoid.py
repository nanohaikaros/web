...
try:
    ...
    # lookup
    ipaddrs = getipaddrs(hostname)      # could raise socket.gaierrir
...
# someone is playing trickes. Explain the situation and exit.
...
# Otherwise,show hte validated hostanme.
