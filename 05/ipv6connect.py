#!/usr/bin/env python
# Connect Example with IPv6 Awareness - Chapter 5 - ipv6xonnect.py

import socket, sys

def getaddrinfo_pref(host, port, socktype, familypreference = socket.AF_INET):
    """Given a host, portm and socktype (usually socket.SOCKET_STREAM or
    socket.SOCK_DGRAM, look up information with both IPv4 and IPv6. If
